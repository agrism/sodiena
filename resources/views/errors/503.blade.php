...
@section('title', '503 — Tehniskie darbi | Šodiena')
    ...
    <div class="max-w-xl w-full text-center space-y-8">
        ...
        <div class="relative mx-auto w-32 h-32 flex items-center justify-center">
            ...
            <div class="w-28 h-28 rounded-3xl bg-white border border-slate-200/80 shadow-xl flex flex-col items-center justify-center text-slate-800">
                <i data-lucide="wrench" class="w-12 h-12 text-emerald-600 mb-1"></i>
                <span class="text-xs font-extrabold uppercase tracking-wider text-slate-400">Apkope</span>
            </div>
        </div>
        ...
        <div class="space-y-3">
            <h1 class="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
                Notiek plānotie tehniskie uzlabojumi
            </h1>
            <p class="text-sm sm:text-base text-slate-600 max-w-md mx-auto leading-relaxed">
                Šobrīd veicam sistēmas uzlabojumus, lai pasākumu meklēšana būtu vēl ātrāka un ērtāka. Drīzumā būsim atpakaļ!
            </p>
        </div>
